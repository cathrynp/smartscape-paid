    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:white;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
        ...
        <tr><td style="padding:28px 36px;background:#f0f7eb;margin-top:24px;">
          ...
          <p style="margin:0;font-size:12px;color:#5a7052;">Greenprints by <a href="https://smartscape.co" target="_blank" rel="noopener" style="color:#2d6a1f;">SmartScape</a> ✨AI For Good · Early Access 2026 · Powered by Claude AI, directed by SmartScape's human expertise</p>
        </td></tr>
